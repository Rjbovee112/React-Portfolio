        ...
        return (
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className=" col-md-4 form-group"><img id="phone" src="./assets/antique-close-up-cord-dial-209695 (1).jpg" />
                    ...
                    <div className=" col-md-4 form-group"><img id="resume" src="./assets/ResumeCapture.PNG" />
